...
namespace Service
{
    public class StatServiceImpl : StatService
    {
        ...
        public StatServiceImpl(StatRepository statRepository, StatHospitalRepository statHospitalRepository, UserRepository userRepository)
        {
